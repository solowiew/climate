...
g1 <- ggplot(country_data_graph, aes(x=population/1000000000, y=co2/1000)) + 
  ...
  labs(tag = "(a)") +
  annotate("text", x = 1.433784064, y = 10.174681, label = "Китай", size = 3,
           hjust=+1.3, vjust=0.25) +
  annotate("text", x = 0.082913893, y = 0.779527, label = "Иран", size = 3,
           hjust=+0.5, vjust=-3)+
  geom_segment(aes(x = 0.082913893,y = 0.779527, xend = 0.053517000, yend = 2), 
               colour = "#272928")+
  annotate("text", x = 0.145872000, y = 1.678367, label = "Россия", size = 3,
           hjust=-0.30, vjust=-0.1)+
  annotate("text", x = 1.366418048, y = 2.616449, label = "Индия", size = 3,
           hjust=+1.3, vjust=0.25)+
  annotate("text", x = 0.126860299, y = 1.106664, label = "Япония", size = 3,
           hjust=-0.25, vjust=0.15)+
  annotate("text", x = 0.329064992, y = 5.284697, label = "США", size = 3,
...
g2 <- ggplot(country_data_graph, aes(x=population/1000000000, y=cumsum_co2/1000)) + 
  ...
  theme(axis.line = element_line(colour = "#272928"),
        ...
        plot.tag = element_text(colour = "#272928", vjust = 2))+
  labs(tag = "(б)")+
  annotate("text", x = 1.433784064, y = 219.98577, label = "Китай", size = 3,
           hjust=+1.3, vjust=0.25) +
  annotate("text", x = 0.083517000, y = 85.91523, label = "Германия", size = 3,
           hjust=-0.25, vjust=0.25)+
  annotate("text", x = 0.145872000, y = 113.45257, label = "Россия", size = 3,
           hjust=-0.30, vjust=0.25)+
  annotate("text", x = 1.366418048, y = 51.83377, label = "Индия", size = 3,
           hjust=+1.3, vjust=0.25)+
  annotate("text", x = 0.126860299, y = 64.42432, label = "Япония", size = 3,
           hjust=-0.24, vjust=0.35)+
  annotate("text", x = 0.329064992, y = 400.23657, label = "США", size = 3,
           hjust=-0.5, vjust=0.25)+
  xlab("Население 2019 г., млрд.")+
